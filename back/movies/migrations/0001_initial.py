# Generated by Django 4.2.8 on 2024-05-23 22:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail_count', models.IntegerField(blank=True, null=True)),
                ('name_kr', models.CharField(blank=True, max_length=300, null=True)),
                ('overview_kr', models.TextField(blank=True, null=True)),
                ('genres', models.ManyToManyField(related_name='genre_movies', to='movies.genre')),
                ('keywords', models.ManyToManyField(blank=True, related_name='keyword_movies', to='movies.keyword')),
                ('like_user', models.ManyToManyField(blank=True, related_name='liked_movies', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='UserGenre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_2', models.CharField(choices=[('a', '재난'), ('b', '외계인'), ('c', '중세 권력 싸움'), ('d', '탐정'), ('e', '가족 드라마'), ('f', '권력싸움'), ('g', '귀여움'), ('h', '즐거움'), ('i', '상상력'), ('j', '스릴')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_user', models.ManyToManyField(blank=True, related_name='liked_reviews', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_user', models.ManyToManyField(blank=True, related_name='liked_people', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='movie',
